...
- [(4) VS Codeを使用しようとしたらgitが見つかりませんと表示される](#4)
- [(5) `code` コマンドの設定手順](#5)
- [(6) VS Codeが日本語で表示されない](#6)
  - [(6-1) VS Codeの拡張機能をインストールする](#6-1)
---
...
## (2) VS Codeが日本語で表示されない <a id="6"></a>

VS Code公式の拡張機能をインストールすることで日本語に変更できます。

### (2-1) VS Codeの拡張機能をインストールする <a id="6-1"></a>
